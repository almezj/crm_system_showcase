...
const ProposalItemPieceImageUpload = ({ proposalItemPieceId, pieceId, proposalId, proposalItemId, onImageChange }) => {
  ...
  const handleUpload = () => {
    ...
    formData.append('proposal_item_piece_id', proposalItemPieceId);
    formData.append('proposal_id', proposalId);
    formData.append('proposal_item_id', proposalItemId);
  ...
  const handleDelete = (imageId) => {
    if (window.confirm('Are you sure you want to delete this proposal-specific image?')) {
  ...
  return (
    <div className="proposal-item-piece-image-upload">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h6 className="mb-0">
          <i className="fas fa-file-image me-2"></i>
          Proposal-Specific Piece Image
        </h6>
        <Button 
      ...
      <div className="image-gallery">
        {pieceImages.length > 0 ? (
                ...
                <Card className="image-card h-100 shadow-sm border-0">
                  <div className="image-container position-relative" style={{ height: '250px', overflow: 'hidden' }}>
                    <Image 
                      ...
                      alt={image.description || 'Proposal piece image'}
                    ...
                    <div className="image-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-between p-3" 
                      ...
                      <div className="d-flex justify-content-between align-items-start w-100">
                        <Badge 
                          bg={image.is_primary ? "info" : "secondary"}
          ...
          <div className="text-center py-4">
            <p className="text-muted">No proposal-specific images uploaded yet</p>
            <p className="text-muted small mb-3">
              Upload a proposal-specific image to override the general piece image for this proposal.
            </p>
            <Button 
              variant="outline-info" 
              onClick={() => setShowUploadModal(true)}
      ...
      <Modal show={showUploadModal} onHide={() => setShowUploadModal(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Upload Proposal-Specific Piece Image</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="alert alert-info">
            <i className="fas fa-info-circle me-2"></i>
            This image will override the general piece image for this specific proposal only.
          </div>
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                placeholder="e.g., Proposal-specific view, Custom angle, etc."
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              <Form.Check
                type="checkbox"
                label="Set as primary image for this proposal"
                checked={isPrimary}
                onChange={(e) => setIsPrimary(e.target.checked)}
              />
              <Form.Text className="text-muted">
                Primary images are used in PDFs and as the main display image for this proposal
              </Form.Text>
            </Form.Group>
          </Form>
        </Modal.Body>
      ...
      <style jsx>{`
        .proposal-item-piece-image-upload {
          margin-bottom: 1rem;
        }
...
export default ProposalItemPieceImageUpload; 